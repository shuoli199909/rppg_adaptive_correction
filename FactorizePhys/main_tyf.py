...
# train UBFC --->  test UBFC
# yaml_name = "configs/tyf_configs/UBFC-rPPG_UBFC-rPPG_FactorizePhys_FSAM_Res.yaml"

# train UBFC --->  test BUAA
# yaml_name = "configs/tyf_configs/UBFC-rPPG_BUAA_FactorizePhys_FSAM_Res_tyf.yaml"
# yaml_name = "configs/tyf_configs/UBFC-rPPG_BUAA_FactorizePhys_Base_tyf.yaml"
# yaml_name = "configs/tyf_configs/UBFC-rPPG_BUAA_PHYSFORMER_BASIC_tyf.yaml"

# yaml_name = "configs/tyf_configs/UNSUPERVISED.yaml"



# train UBFC --->  test LGI
yaml_name = "configs/tyf_configs/UBFC-rPPG_LGI_FactorizePhys_FSAM_Res_tyf.yaml"
...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "only_train":
        ...
        elif config.TEST.DATA.DATASET == "BUAA-MIHR":
            test_loader = data_loader.BUAAMIHRLoader.BUAAMIHRLoader
        elif config.TEST.DATA.DATASET == "LGI-PPGI":
            test_loader = data_loader.LGIPPGILoader.LGIPPGILoader
        ...
        elif config.UNSUPERVISED.DATA.DATASET == "BUAA-MIHR":
            unsupervised_loader = data_loader.BUAAMIHRLoader.BUAAMIHRLoader
        elif config.UNSUPERVISED.DATA.DATASET == "LGI-PPGI":
            unsupervised_loader = data_loader.LGIPPGILoader.LGIPPGILoader
