...
class BlandAltman():
    ...
    def __init__(self,gold_std,new_measure,config,averaged=False):
        ...
        if config.TOOLBOX_MODE == 'train_and_test' or config.TOOLBOX_MODE == 'only_test':
            ...
            self.save_path  = os.path.join(config.LOG.PATH, config.VALID.DATA.EXP_DATA_NAME, 'bland_altman_plots')
    ...
    def scatter_plot(self,x_label='Gold Standard',y_label='New Measure',
        ...
        try:
            ...
            print("Too few or degenerate samples for KDE in difference plot, skipping...")
            return
