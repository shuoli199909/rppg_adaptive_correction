...
class LGIPPGILoader(BaseLoader):
    ...
    def get_raw_data(self, data_path):
        ...
        # data_dirs = glob.glob(data_path + os.sep + "*_talk") # tyf change
        data_dirs = [os.path.join(data_path, d) for d in os.listdir(data_path) if
